...
default_engine_settings = {
    ...
    TTS_ENGINES['PIPER']: {
        ...
        "voices": {
            ...
            "uk_UA-tetiana-high":               "Tetiana",
            "uk_UA-mykyta-high":                "Mykyta",
            "uk_UA-oleksa-high":                "Oleksa",
    ...
    TTS_ENGINES['STYLETTS2']: {
        ...
        "diffusion_steps": 10,
        "files": [],
        "speakers_path": os.path.join(voices_dir, '__styletts2'),
        "voice": os.path.join(voices_dir, '__styletts2', 'Артем Окороков.wav'),
        "voices": {
            "Інна Гелевера":          "Інна Гелевера",
            "Анастасія Павленко":     "Анастасія Павленко",
            "Артем Окороков":         "Артем Окороков",
            "Вʼячеслав Дудко":        "Вʼячеслав Дудко",
            "Вероніка Дорош":         "Вероніка Дорош",
            "Влада Муравець":         "Влада Муравець",
            "Вікторія Левченко":      "Вікторія Левченко",
            "Гаська Шиян":            "Гаська Шиян",
            "Денис Денисенко":        "Денис Денисенко",
            "Катерина Потапенко":     "Катерина Потапенко",
            "Кирило Татарченко":      "Кирило Татарченко",
            "Людмила Чиркова":        "Людмила Чиркова",
            "Марина Панас":           "Марина Панас",
            "Марися Нікітюк":         "Марися Нікітюк",
            "Марта Мольфар":          "Марта Мольфар",
            "Марічка Штирбулова":     "Марічка Штирбулова",
            "Матвій Ніколаєв":        "Матвій Ніколаєв",
            "Михайло Тишин":          "Михайло Тишин",
            "Олександр Ролдугін":     "Олександр Ролдугін",
            "Олена Шверк":            "Олена Шверк",
            "Павло Буковський":       "Павло Буковський",
            "Петро Філяк":            "Петро Філяк",
            "Поліна Еккерт(хлопчик)": "Поліна Еккерт(хлопчик)",
            "Поліна Еккерт":          "Поліна Еккерт",
            "Роман Куліш":            "Роман Куліш",
            "Слава Красовська":       "Слава Красовська",
            "Тарас Василюк":          "Тарас Василюк",
            "Тетяна Гончарова":       "Тетяна Гончарова",
            "Тетяна Лукинюк":         "Тетяна Лукинюк",
            "Юрій Вихованець":        "Юрій Вихованець",
            "Юрій Кудрявець":         "Юрій Кудрявець",
        },
        "rating": {"VRAM": 2, "CPU": 3, "RAM": 3, "Realism": 5}
    },
    TTS_ENGINES['VITS']: {
